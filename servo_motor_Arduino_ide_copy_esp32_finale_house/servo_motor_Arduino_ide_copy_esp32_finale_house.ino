...
const char* topic_porta = "techeagles/sala/porta";

// --- Pinos ---
const int luzSala = 13;
const int rele = 15;
const int servoMotor = 22;
...
void acenderLedMovimento() {
  ...
  distanciaCm = (duracao * 0.0343) / 2;  // Converte tempo em distância (cm)
...
void setup() {           //configuração inicial dos sensores
  ...
  motor.write(0);          //porta fechada está em 180 grau do motor !!!
